...
interface CVSectionClientProps {
    experiences: Experience[];
}

// Fonction pour déterminer l'icône basée sur icon_type
function getIcon(iconType: string) {
    if (iconType === 'GraduationCap') {
        return GraduationCap;
    }
    return Briefcase;
}

export default function CVSectionClient({ experiences }: CVSectionClientProps) {
    return (
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-12">
                            {experiences.map((exp, index) => {
                                const Icon = getIcon(exp.icon_type);
